...
QFirmwareUpgrade::QFirmwareUpgrade()
{
...
void QFirmwareUpgrade::startFWUpgrade()
{
    getFWFile();
...
//펌웨어 파일 로드 풀Path로 받음
bool QFirmwareUpgrade::loadFirmwareFile(QString strFirmwareFilePathName)
{
    m_FirmwareInfo.clear();
...
void QFirmwareUpgrade::loadFirmwarePartFile(QString strPath)
{
    m_FirmwareInfo.clear();
...
FirmwareInfo* QFirmwareUpgrade::findFirmware( FIRMWARE_TYPE type, unsigned short nModelNumber )
{
...
bool QFirmwareUpgrade::analysisFirmwareBinary( const char* ver_info, FirmwareInfo* pFI )
{
...
void QFirmwareUpgrade::onDisconnected()
{
    qDebug( "disconnected" );
...
void QFirmwareUpgrade::timerEvent(QTimerEvent *evt)
{
...
void QFirmwareUpgrade::startQueryInformation(bool bDelay)
{
...
void QFirmwareUpgrade::stopQueryInformation()
{
    if (m_TimerRequestInformation)
    {
        killTimer(m_TimerRequestInformation);
...
void QFirmwareUpgrade::startFirmwareDownload()
{
    //ui->listWidget->clear();
...
void QFirmwareUpgrade::stopFirmwareDownload()
{
    if (m_TimerRequestInformation)
    {
        killTimer(m_TimerRequestInformation);
...
void QFirmwareUpgrade::firmwareDownload()
{
    stopAllFirmwareDownloadJobs();
...
void QFirmwareUpgrade::startRequestTimeoutTimer( int nTimeout )
{
...
void QFirmwareUpgrade::killRequestTimeoutTimer()
{
    if (m_TimerRequestTimeout != 0)
    {
        killTimer(m_TimerRequestTimeout);
...
void QFirmwareUpgrade::startWaitModeChangeTimer()
{
    //ui->labelMessage->setText(CAUTION);
...
void QFirmwareUpgrade::killWaitModeChangeTimer()
{
    //ui->labelMessage->setText(CAUTION);
    if (m_TimerWaitModeChange !=0)
    {
...
void QFirmwareUpgrade::stopAllQueryInformationJobs()
{
    killRequestTimeoutTimer();
...
void QFirmwareUpgrade::stopAllFirmwareDownloadJobs()
{
    killRequestTimeoutTimer();
...
void QFirmwareUpgrade::queryInformation()
{
    stopAllQueryInformationJobs();
...
void QFirmwareUpgrade::onResponseFromSensor(unsigned short nPacketId)
{
...
void QFirmwareUpgrade::executeNextJob( bool bRetry/*=false*/ )
{
    if (!m_bIsExecuteJob)
        return;
...
void QFirmwareUpgrade::onFinishAllRequestInformationJobs()
{
...
void QFirmwareUpgrade::onFinishAllFirmwareDownloadJobs()
{
    m_bIsStartFirmwareDownload = false;
...
void QFirmwareUpgrade::onFirmwareUpdateFailed()
{
...
void QFirmwareUpgrade::displayInformation( const QString& strText )
{
...
void QFirmwareUpgrade::updateSensorInformation()
{
...
void QFirmwareUpgrade::updateFirmwareInformation()
{
...
void QFirmwareUpgrade::getFWFile()
{
    QString	strFileName;

    QString str( "C:\\Source\\140328 ver2.8d\\Binary\\2.8d.fwb" );
//    "C:\Source\140328 ver2.8d\Binary"
//    if( str.isEmpty() ) continue;
//input file Empty -> return false
...
bool QFirmwareUpgrade::verifyFirmware(QString& strMsg)
{
...
bool QFirmwareUpgrade::checkFWVersion(QString& strMsg)
{
    if( m_bAdministrator ) return true;
...
void QFirmwareUpgrade::on_pushButtonUpgrade_clicked()
{
...
void QFirmwareUpgrade::on_pushButtonCancel_clicked()
{
    if (m_bIsStartFirmwareDownload)
    {
        // TODO: confirm cancel
...
void QFirmwareUpgrade::addProgressText(QString& strMessage, TextMode tm)
{
