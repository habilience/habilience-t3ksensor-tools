...
class QCalibrationWidget : public QDialog, public QLangManager::ILangChangeNotify, public QT3kDeviceEventHandler::IListener
{
    Q_OBJECT
public:
    explicit QCalibrationWidget(QT3kDevice*& pHandle, QWidget *parent = 0);
    ~QCalibrationWidget();
