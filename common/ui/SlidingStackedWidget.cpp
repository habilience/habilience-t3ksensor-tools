...
QSlidingStackedWidget::QSlidingStackedWidget(QWidget *parent)
...
QSlidingStackedWidget::~QSlidingStackedWidget(){
}

void QSlidingStackedWidget::setVerticalMode(bool vertical) {
        m_vertical=vertical;
}

void QSlidingStackedWidget::setSpeed(int speed) {
        m_speed = speed;
}

void QSlidingStackedWidget::setAnimation(enum QEasingCurve::Type animationtype) {
        m_animationtype = animationtype;
}

void QSlidingStackedWidget::setWrap(bool wrap) {
        m_wrap=wrap;
}

void QSlidingStackedWidget::slideInNext() {
...
void QSlidingStackedWidget::slideInPrev() {
        int now=currentIndex();
        if (m_wrap||(now>0))
                slideInIdx(now-1);
}

void QSlidingStackedWidget::slideInIdx(int idx, enum t_direction direction) {
...
void QSlidingStackedWidget::slideInWgt(QWidget * newwidget, enum t_direction  direction) {
...
void QSlidingStackedWidget::animationDoneSlot(void) {
