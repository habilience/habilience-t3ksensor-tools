...
void QGestureMappingTable::onChangeLanguage()
{
    QLangRes& Res = QLangManager::instance()->getResource();
    m_aryCell[TABLE(COL_MOVE, 0)].strText                        = Res.getResString( QString::fromUtf8("MOUSE SETTING"), QString::fromUtf8("TEXT_DRAG") );
    m_aryCell[TABLE(COL_TAP, 0)].strText                         = Res.getResString( QString::fromUtf8("MOUSE SETTING"), QString::fromUtf8("TEXT_TAP") );
    m_aryCell[TABLE(COL_DBLTAP, 0)].strText                      = Res.getResString( QString::fromUtf8("MOUSE SETTING"), QString::fromUtf8("TEXT_DOUBLE_TAP") );
    m_aryCell[TABLE(COL_LONGTAP, 0)].strText                     = Res.getResString( QString::fromUtf8("MOUSE SETTING"), QString::fromUtf8("TEXT_LONG_TAP") );
    ...
    m_aryCell[TABLE(0, 1)].strText                               = Res.getResString( QString::fromUtf8("MOUSE SETTING"), QString::fromUtf8("TEXT_SINGLE") );
    m_aryCell[TABLE(0, 2)].strText                               = Res.getResString( QString::fromUtf8("MOUSE SETTING"), QString::fromUtf8("TEXT_FINGERS") );
    m_aryCell[TABLE(0, 3)].strText                               = Res.getResString( QString::fromUtf8("MOUSE SETTING"), QString::fromUtf8("TEXT_PALM") );
    m_aryCell[TABLE(0, 4)].strText                               = Res.getResString( QString::fromUtf8("MOUSE SETTING"), QString::fromUtf8("TEXT_PUTNTAP") );
...
void QGestureMappingTable::mousePressEvent(QMouseEvent *e)
{
    ...
    if ( (m_ciZoom.bEnable && !m_ciZoom.bNotUsed) && m_ciZoom.rectCell.contains( e->pos() ) )
    {
...
#ifdef SUPPORT_ROTATE
    if ( (m_ciRotate.bEnable && !m_ciRotate.bNotUsed) && m_ciRotate.rectCell.contains( e->pos() ) )
    {
...
void QGestureMappingTable::onUpdateInputMode()
{
    switch( m_nProfileIndex )
    {
    case 1:
